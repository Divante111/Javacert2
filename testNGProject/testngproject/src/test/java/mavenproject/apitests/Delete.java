...
public class Delete {
    ...
    public void createBookingTest(){
        ...
        Response responsePatch = RestAssured.given().auth().preemptive().basic("admin", "password123").contentType(ContentType.JSON).body(body.toString()).delete("https://restful-booker.herokuapp.com/booking/" + bookingId);// https://restful-booker.herokuapp.com/booking/1 


//      "username" : "admin",
//     "password" : "password123"

        Assert.assertEquals(responsePatch.getStatusCode(), 201, "Status code should be 200, but it's not");
        
        System.out.println("-----------------------------------------------");

        Response checkAfterPatch = RestAssured.given().contentType(ContentType.JSON).get("https://restful-booker.herokuapp.com/booking/" + bookingId);
