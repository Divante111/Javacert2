...
public class PutTest {
    ...
    public void createBookingTest(){
        ...
        body = new JSONObject();
        body.put("firstname" , "changed123");
        body.put("lastname" , "changed345");
        ...
        Response responsePatch = RestAssured.given().auth().preemptive().basic("admin", "password123").contentType(ContentType.JSON).body(body.toString()).put("https://restful-booker.herokuapp.com/booking/" + bookingId);// https://restful-booker.herokuapp.com/booking/1 
