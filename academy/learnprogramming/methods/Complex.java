...
public class Complex {
    ...
    public static void main(String[] args) {
        ...
        Complex combined = Complex.plus(a, b);

        System.out.println("a = " + a.real + " imaginary= " + a.imaginary);
        System.out.println("b = " + b.real + " imaginary= " + b.imaginary);
        System.out.println("bPlusA = " + bPlusA.real + " imaginary= " + bPlusA.imaginary);
        System.out.println("combined = " + combined.real + " imaginary= " + combined.imaginary);
