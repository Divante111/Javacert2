...
public class FormattingDateTime {
    public static void main(String[] args) {
        ...
        // System.out.println(shortFormatter.format(time)); //java.time.temporal.UnsupportedTemporalTypeException: Unsupported field: MonthOfYear

        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("MMMM dd, yyyy, hh:mm:dd");
